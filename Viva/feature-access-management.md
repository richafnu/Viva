...
:::image type="content" source="./media/viva-feature-access-workflow.png" alt-text="Workflow diagram that shows the steps for applying a feature access policy." lightbox="./media/viva-feature-access-workflow.png":::
