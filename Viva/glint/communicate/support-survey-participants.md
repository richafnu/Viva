...
> [!NOTE]
> Viva Glint Admins need [access to Advanced Configuration](/viva/glint/setup/understand-advanced-configuration.md#grant-access-to-an-existing-admin-user) to export recipients for Lifecycle and Always-On surveys.
