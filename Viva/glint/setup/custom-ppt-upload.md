...
description: Share and create customized Viva Glint feedback report templates. Save them in a customized folder.
...
- **Viva Glint logo** 
 ...
 - **Special text replacement values**
   ...
   - **Survey Name:** if you add the text “Survey Name” in the text, this is replaced with the name of the Survey set in your Viva Glint platform. For example, "Culture Survey", "Engagement Survey", or "People Survey." 
   - **Report.Name:**  if you add the text "Report.Name" in a text box, this is replaced with the name of the chosen report. For example, "Executive Summary Report" or “Heat Map Report." 
...
- **NORMAL:** The images on the slide take up 80% of the slide width. This placement leaves space on the right for text or annotations. The Viva Glint Default Template uses **NORMAL**. 
...
- In a customized template, you can have any number of static slides before or after the placeholder slide. Other static slides could be, for example, slides containing a list of internal resources that can be used when reviewing survey results. You need to manually create these slides and add them to the template.  
...
2. Find the Slide Master layout slide named "Report Content Layout."  In the Viva Glint default template, this slide shows last in the Slide Master view and is usually blank. If unsure, hover over the page with your mouse and you should see the slide named as “Report Content Layout”. 
...
5.	Now when opening the folder, custom templates are available. From the folder name, you can see the number of languages the template exists in and the number of surveys the custom template is linked to. Access each individual template in the folder.
