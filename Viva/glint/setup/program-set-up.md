...
| **Admin Notifications to** |These admins are notified of upcoming surveys and are set in General Settings.|Each survey should have at least one admin in this role who is notified before the survey goes Live. Use the **Search** add names.|
...
|Field|Description|Examples/Tips|
|-------|------------|-----------|
|**Confidential responses** | Set to **Custom Confidential** by default to promote accurate feedback|
...
>[!TIP]
> - **Survey level custom messaging takes precedence.** Custom messaging set up in General Settings but edited at the survey level, overrides the initial messaging.
