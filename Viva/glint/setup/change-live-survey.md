...
:::image type="content" source="../../media/glint/setup/questions-confirm-no-association-2.png" alt-text="Screenshot of Confirm before saving dialog box for text edit for item with no associated benchmark." lightbox="../../media/glint/setup/questions-confirm-edits-only.png":::
