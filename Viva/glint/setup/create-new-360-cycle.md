...
:::image type="content" source="viva/media/glint/setup/360-cycle-settings-first.png"alt-text="Screenshot of the five sections to configure in Cycle Settings.":::
...
:::image type="content" source="viva/media/glint/setup/360-the-basics-2.png"alt-text="Screenshot of the first section to configure in Cycle Settings.":::

### Feedback provider category settings and confidentiality

:::image type="content" source="viva/media/glint/setup/360-categories-confidentiality-2.png"alt-text="Screenshot of the second section to configure in Cycle Settings.":::
...
:::image type="content" source="viva/media/glint/setup/360-edit-provider-category-2.png"alt-text="Screenshot of an example of a window that opens to edit a feedback provider category.":::
...
:::image type="content" source="viva/media/glint/setup/360-provider-response-info-2.png"alt-text="Screenshot of the Feedback Provider Response Information window.":::
