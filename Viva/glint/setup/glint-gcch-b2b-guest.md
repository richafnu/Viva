...
description: For organizations with Viva Glint installed to a commercial tenant, admins have the option to invite users that need dashboard access from GCC-High cloud tenants as B2B collaboration users.
...
Microsoft Viva Glint is available for commercial tenants but isn't available for Government Community Cloud (GCC) or Government Community Cloud High (GCC-High) entities. For organizations with Viva Glint installed to a commercial tenant, admins have the option to invite users that need dashboard access from GCC-High cloud tenants as B2B collaboration users. Consider Viva Glint survey access methods, Microsoft Entra configuration steps, data upload requirements in the Viva Glint app, and the B2B guest user sign-in experience when inviting GCC-High users to your commercial tenant.
...
To limit the amount of users that need to be invited to the commercial tenant, use a survey access method that doesn't require authentication for survey takers. Choose from personalized links or attribute-based access:
...
2. [Invite B2B guest users](#invite-b2b-guest-users-in-bulk)
...
### Invite B2B guest users in bulk
...
2. [Follow steps to invite guest users in bulk](/entra/external-id/tutorial-bulk-invite#invite-guest-users-in-bulk)
...
7. Complete multi-factor authentication steps to sign in.
