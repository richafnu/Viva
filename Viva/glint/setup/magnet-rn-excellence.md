...
Choose any prepopulation Recurring survey template and customize it to create the RN Excellence/Magnet®️ survey. Search our Question Library for the core survey items in this table.

> [!CAUTION]
> Don't use the Blank Recurring survey template to set up a Magnet©️ survey. This template doesn't support multiple survey cycles.
