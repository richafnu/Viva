...
1. Use the **Edit** option to open an edit pane and make changes to each part of the conversation presentation: 
   ...
   - **How we're doing**
      - **Section Name:** The label that appears in the conversation menu
      - **Slide Headings:** The bold-faced header for the Thank you, High-Level Results, Biggest Changes, Relative Strengths, Relative Opportunities, and Multiple Choice Questions slides
      - **Thought Starters:** The plain text description for the Thank you, High-Level Results, and Biggest Changes slides
      - **Subtexts:** The plain text description for the Relative Strengths and Relative Opportunities slides
