...
| Field | Definition and notes |
|:-----------|:-----------|
|**Comment Analytics Language**   |The list of codes for languages to include for comment analysis. Empty value signifies English only. The number of available languages also shows.   |
