...
Every Microsoft Viva Glint survey includes links to a privacy policy that users can access. The privacy policy can be either:
...
> [!NOTE]
> The Microsoft Privacy Statement displays on all Glint email footers and login screens.
