...
# Use Viva Glint Employee Attribute Template
...
## Why use the employee data template? 
...
The first page of the attribute template contains instructions for documenting information in the file and Viva Glint data requirements. Follow the guidance on the instruction page and in the following table to structure your data and document decisions.
