---
ms.date: 04/03/2024
title: "The News Reader in Viva Connections"
ms.reviewer: 
ms.author: evanatkin
author: AtkinE
manager: elizapo
...
- SPO160
- MET150
description: "Learn more about the News reader, how it pulls content from SharePoint news sites across your organization, and how to use the Copilot powered news summary feature."
---
...
![Screenshot of the share options available when accessing a news item.](../media/connections/news-reader/share-options.png)

Users can select the **thumbs up** icon ( ![Thumbs up icon](../media/connections/news-reader/thumbs-up-icon.png) ) on a news card to like the news post, or select the **bookmark** icon ( ![Bookmark icon](../media/connections/news-reader/bookmark-icon.png) )to save the news post for later reading. Select the **bookmark** icon again to remove the bookmark.
